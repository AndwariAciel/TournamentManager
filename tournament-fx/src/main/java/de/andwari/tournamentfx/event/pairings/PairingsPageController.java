package de.andwari.tournamentfx.event.pairings;
...
import de.andwari.tournamentcore.matches.MatchFactory;
...
public class PairingsPageController {
	...
	public void nextPage() {
		Player bye = byeText.getText() != null && !byeText.getText().isEmpty() ? parsePlayer(byeText.getText()) : null;
		Round round1 = matchFactory.createManualPairings(event, listLeft, listRight, listPlayers, bye);
