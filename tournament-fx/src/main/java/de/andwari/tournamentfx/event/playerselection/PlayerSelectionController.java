...
import de.andwari.tournamentfx.event.pairings.PairingsPageController;
import de.andwari.tournamentfx.event.seatings.SeatingsPageController;
import de.andwari.tournamentfx.event.settings.EventSettingsPageController;
import de.andwari.tournamentfx.playermanagement.PlayerConverter;
import de.andwari.tournamentfx.playermanagement.PlayerDVO;
import de.andwari.tournamentfx.playermanagement.TabPlayerService;
...
public class PlayerSelectionController {
	...
	public void startEvent() {
		...
		EventSettingsPageController settingsController = openNewWindow(FxmlResource.EVENT_SETTINGS);
	...
	private EventSettingsPageController openNewWindow(FxmlResource resource) {
		EventSettingsPageController controller = null;
		FXMLLoader fxmlLoader = fxmlLoaderInst.get();
		try {
			fxmlLoader.setLocation(resource.getResourceUrl());
