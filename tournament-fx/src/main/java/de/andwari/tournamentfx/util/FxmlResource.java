package de.andwari.tournamentfx.util;
...
public enum FxmlResource {
	...
	EVENT_STANDINGS_OVERVIEW("event/StandingOverview"), ADD_PLAYER("event/AddPlayer");

	private final static String PREFIX = "de/andwari/";
